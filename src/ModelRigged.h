...
class ModelRigged : public ModelAbstract {
    ...
    struct DynamicBone {
        ...
        DynamicBone() : linearVel(0.0f, 0.0f, 0.0f), angularVel(1.0f, 0.0f, 0.0f, 0.0f), linearAcc(0.0f, 0.0f, 0.0f), angularAcc(1.0f, 0.0f, 0.0f, 0.0f) {}
    };
    ...
    void ragdoll(map<int, DynamicBone>& dynamicBones, vector<glm::mat4>& boneTransforms) const;
    ...
    void ragdollNodes(const Node* node, map<int, DynamicBone>& dynamicBones, glm::mat4 combinedTransform, vector<glm::mat4>& boneTransforms) const;
